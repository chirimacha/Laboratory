...
#  IIa. Total distance traveled by hour by the bugs
#  IIb. In an open area: total distance AND total distance traveled by hour by the bugs (two results)
#===================================================================================
#===================================================================================
# Part IIa: Total distance traveled by hour by the bugs
#===================================================================================
...
#===================================================================================
# Part IIb. In an open area: total distance AND total distance traveled by hour by the bugs (two results)
#===================================================================================
TimeMoving <- function(df, inputPoly) {
  ...
  toReturn["minutes.staying"]<-round((((max(toReturn[,2])-toReturntime[,2])/29.9)/60)*8,digits = 1)
...
#  IIId. Built a unique data frame with hour 1,2 and 3
...
#===================================================================================
# Part IIId. Built a unique data frame with hour 1,2 and 3
#===================================================================================
