...
plot(CompileRD$week+rnorm(length(CompileRD$eggs), 0, 0.5), CompileRD$eggs)
...
nbmod2q<-glm.nb(eggs ~ infected*weeknum+humdiff+(1|idnum), data=Compile)# 
nbmod2r<-glm.nb(eggs ~ infected*weeknum+humdiff+humdiff*infected+(1|idnum), data=Compile)
nbmod2s<-glm.nb(eggs ~ infected*weeknum+tempmax+ (1|idnum), data=Compile)#
nbmod2t<-glm.nb(eggs ~ infected*weeknum+tempmax+tempmax*infected+(1|idnum), data=Compile)
nbmod2u<-glm.nb(eggs ~ infected*weeknum+tempmin+(1|idnum), data=Compile)#
nbmod2v<-glm.nb(eggs ~ infected*weeknum+avhum+tempmin*infected+(1|idnum), data=Compile)
nbmod2w<-glm.nb(eggs ~ infected*weeknum+avhum+(1|idnum), data=Compile)#
nbmod2z<-glm.nb(eggs ~ infected*weeknum+avhum+avhum*infected+(1|idnum), data=Compile)
