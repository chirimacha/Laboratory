...
inwd <- paste("/Users/jeniferpeterson/Desktop/Laboratory/",
              "Inesfly_Paint_Bed_Bug_Trial/TABLES_GRAPHS","/Fig3Speed",
              sep = "")
...
#NOTE: First column is insect id, then date, then which plate
...
PlotSpeed <- function(csTest, num){
  ...
  mn.tile.t <- paste(num, d, "Insecticide group")
  mn.tile.c <- paste(num, d, "Control group")
