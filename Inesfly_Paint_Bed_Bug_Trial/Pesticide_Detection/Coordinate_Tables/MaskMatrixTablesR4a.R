...
cMYT <-c(430,430,430,250,240,240)
cMYB <-c(250,240,240,060,060,060)
...
cTPX <-c(261,433,613,275,447,617)
cTPY <-c(389,391,397,205,210,221)
cBPX <-c(269,438,614,273,444,622)
cBPY <-c(233,237,241,053,054,065)
cLPX <-c(176,355,536,183,366,546)
cLPY <-c(306,306,318,131,134,141)
cRPX <-c(340,518,693,347,525,699)
cRPY <-c(314,316,324,133,135,151)
#c(,,,,,)
